...
- **项目**：小林 OnCall Agent 项目
- **说明**：参考其 OnCall Agent 场景设计、诊断流程和面试项目表达方式

如果你公开发布包含第三方语料或参考内容的版本，请遵守原项目的许可和署名要求。
...
项目中的部分 RAG 知识库语料整理自 `samber/awesome-prometheus-alerts`，其原始内容遵循 CC BY 4.0；项目设计也参考了小林 OnCall Agent 项目的场景设计和诊断思路。公开发布时请保留来源与许可说明。
